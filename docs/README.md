...
- 想改中文拆词、成对符号输入、错字模拟或输入节奏：看 [输入流程与延迟策略](typing-pipeline.md)。
...
| 修改成对符号输入 | `typing-pipeline.md` | `src/typing/input_plan.rs`, `src/typing/engine.rs` |
...
- `src/typing/` 负责文本拆分、词库、成对符号输入计划、错字模拟、延迟预算和键盘输出。
